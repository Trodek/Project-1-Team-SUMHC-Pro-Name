...
ModuleCollision::ModuleCollision()
{
	...
	matrix[COLLIDER_PLAYER_EBULLETS][COLLIDER_SPEED] = false;
	matrix[COLLIDER_PLAYER_EBULLETS][COLLIDER_SHIELD] = false;
	matrix[COLLIDER_PLAYER_EBULLETS][COLLIDER_EXTRA_BOMB] = false;
