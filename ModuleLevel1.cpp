...
bool ModuleLevel1::Start(){
	...
	// walls
	colliders.PushBack(App->collisions->AddCollider({ 0, 13700, 123, 145 }, COLLIDER_PASS_BULLET));
	colliders.PushBack(App->collisions->AddCollider({ 0, 13843, 32, 35 }, COLLIDER_PASS_BULLET));
	colliders.PushBack(App->collisions->AddCollider({ 198, 13699, 58, 143 }, COLLIDER_PASS_BULLET));
	colliders.PushBack(App->collisions->AddCollider({ 0, 13414, 61, 141 }, COLLIDER_PASS_BULLET));
	colliders.PushBack(App->collisions->AddCollider({ 136, 13410, 120, 146 }, COLLIDER_PASS_BULLET));
