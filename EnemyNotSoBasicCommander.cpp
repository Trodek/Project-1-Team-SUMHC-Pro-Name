...
EnemyNotSoBasicCommander::EnemyNotSoBasicCommander(int x, int y, ENEMY_TYPES type) : Enemy(x, y, type){
...
void EnemyNotSoBasicCommander::Move(){
...
void EnemyNotSoBasicCommander::Draw(){
...
void EnemyNotSoBasicCommander::Shot(){
