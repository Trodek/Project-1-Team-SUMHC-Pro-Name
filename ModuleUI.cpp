...
update_status ModuleUI::Update(){
	...
	if (game){
		...
		if (!energy_sound && energy < 0 && (((energy*energy) + energy_cont % (4 * (energy - 1) + 1) < (energy * energy + energy + 2)) && energy < 9)) { //Don't ask me about this equation. PLS. 1 hour working on it :DDDD
